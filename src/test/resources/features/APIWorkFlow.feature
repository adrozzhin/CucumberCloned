Feature: Syntax HRM API workflow
  ...
  Scenario: Retrieving created employee
    ...
    And the retrieved data at "employee" object matches the data used to create an employee with emplyee id "employee.employee_id"
      | emp_firstname | emp_middle_name | emp_lastname | emp_birthday | emp_gender | emp_job_title | emp_status |
      | AndreiD       | 654321dr        | Dr123456     | 1999-12-04   | Male       | API Tester    | Employee   |
